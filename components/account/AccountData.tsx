        ...
        <div className="space-y-2">
          <div>
            ...
            <div className="text-md text-gray-900">
              {userDetail.account_usdc} <b className="text-sm">USDC</b>
            </div>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <div className="text-md text-gray-900">
              {userDetail.invested_usdc} <b className="text-sm">USDC</b>
            </div>
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700">
            ...
            <div className="text-md text-gray-900">
              {userDetail.uninvest_usdc} <b className="text-sm">USDC</b>
            </div>
          </div>
        </div>
      </div>
