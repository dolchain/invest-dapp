...
export default async function Admin() {
  ...
  const { data: centralWallet } = await supabase.from('config').select('*').eq('key', 'central_wallet').single();
  console.log(allUsers);
  console.log(centralWallet.value);
  ...
  return (
    <>
      <Users users={allUsers} centralWalletAddress={centralWallet.value} />
